    ...
    public partial class OQQMainPanel : Form
    {
        ...
        public void getReciveMsg()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Recive:-" + returnMsg + "-");
                    ...
                    switch ((string)obj["act"])
                    {
                        case "recivemsg":
                            if (obj["userid"] != null)
                            {
                                ...
                                fri.MsgNum++;
                                if(fri.FriendID.Equals(Global.Fruserid))
                                {
                                    this.Invoke(new Action<Friend>(updateMsg), new object[] { fri });
                                }
                                else
                                {
                                    this.Invoke(new Action<Friend>(upfrui), new object[] { fri });
                                }
                            }
                            break;
                        case "addfriend":
                        ...
                        case "serchfrend":
                            ...
                            break;
                        default:
                            Console.WriteLine((string)obj["act"]);
                            break;
                    }
                }
               else
        ...
        private void friend_mclick_1(object sender, EventArgs e)
        {
            ...
            Global.Fruserid = fr.FriendID;
            this.label2.Text = fr.FriendName;
            updateMsg(fr);
        }

        private void updateMsg(Friend fr)
        {
            this.textBox1.Text = "";
        ...
        {
            Global.serFr(textBox3.Text.ToString());
        }

        private void button4_Click(object sender, EventArgs e)
        {
            String msg = textBox2.Text.ToString();
            Global.SendMyMsg(msg, Global.Fruserid);
        }
    }
}
